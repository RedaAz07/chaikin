...
async fn main() {
    ...
    loop {
        ...
        // --- INPUT ---
        // Only allow drawing if NOT running
...
fn chaikinAlgo(points: &mut Vec<(f32, f32)>) {
    // Safety check prevents crashing if called on empty list
